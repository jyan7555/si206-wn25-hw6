...
class TestHomework6(unittest.TestCase):
   ...
   def test_get_highest_box_office_movie_by_genre(self):
       ...
       self.assertEqual(test_2[0], 'Titanic')  # Check only the title
   ...
   def test_recommend_similar_movies(self):
       ...
       self.assertEqual(test_1, ['Little Women', 'Top Gun', 'La La Land', 'Whiplash',
                                  '12 Years a Slave', 'Life of Pi', 'The Help', 'Killers of the Flower Moon', 
                                  'Oppenheimer', 'Braveheart', 
   ...
   def test_get_movie_rating(self):
       ...
       # Top Gun is in the data, not Top Gun
       test_topgun = get_movie_rating('Top Gun', 'cache.json')
       self.assertEqual(test_topgun, '59%')
